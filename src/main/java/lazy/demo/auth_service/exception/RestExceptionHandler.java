...
public class RestExceptionHandler {
    ...
    protected ResponseEntity<GenericResponse<ApiError>> handleEntityNotFound(
    ...
    protected ResponseEntity<GenericResponse<ApiError>> handleDataIntegrityViolation(DataIntegrityViolationException ex,
                                                                  WebRequest request) {
